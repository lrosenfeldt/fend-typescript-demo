...
export type ProgramManyWhereInput = {
  ...
  /** All values that are contained in given list. */
  focus_in?: InputMaybe<Array<Focus>>;
  /** All values that are not equal to given value. */
  focus_not?: InputMaybe<Focus>;
  /** All values that are not contained in given list. */
  focus_not_in?: InputMaybe<Array<Focus>>;
  id?: InputMaybe<Scalars['ID']>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']>;
  /** All values ending with the given string. */
  ...
  /** All values greater than the given value. */
  weeks_gt?: InputMaybe<Scalars['Int']>;
  /** All values greater than or equal the given value. */
  weeks_gte?: InputMaybe<Scalars['Int']>;
  /** All values that are contained in given list. */
  weeks_in?: InputMaybe<Array<Scalars['Int']>>;
  /** All values less than the given value. */
  weeks_lt?: InputMaybe<Scalars['Int']>;
  /** All values less than or equal the given value. */
  weeks_lte?: InputMaybe<Scalars['Int']>;
  /** All values that are not equal to given value. */
  weeks_not?: InputMaybe<Scalars['Int']>;
  /** All values that are not contained in given list. */
  weeks_not_in?: InputMaybe<Array<Scalars['Int']>>;
};
...
export type ScheduledOperationAffectedDocument = Asset | Program;
...
export type AllProgramsQuery = { __typename?: 'Query', programs: Array<{ __typename?: 'Program', id: string, title: string }> };
 ...
 * });
 */
export function useAllProgramsQuery(baseOptions?: Apollo.QueryHookOptions<AllProgramsQuery, AllProgramsQueryVariables>) {
